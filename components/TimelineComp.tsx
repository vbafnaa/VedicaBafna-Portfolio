      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-justify text-sm font-normal text-slate-600 md:text-sm dark:text-neutral-300">
            ...
            accuracy on a blind test-set of 100k real-world complaints with millisecond inference
            times on CPU.
            <br />
            <br />➜ Generated synthetic complaints via a Markov Chain system to augment
            underrepresented complaint classes, filling 88% of missing entries; improved dataset
            coverage by 4.67% and conducted ablation studies to validate tradeoffs in label quality
            vs. data quantity.
            <br />
            <br />➜ Exhibited data-centric AI with a NLI-based mislabel detection pipeline to
            correct manual annotation, increasing accuracy by 18.7%. The entire pipeline is
            currently being deployed on the RailMadad website.
          </p>
          <div className="grid grid-cols-1 gap-4">
            <a href="https://railmadad.indianrailways.gov.in/madad/final/home.jsp">
              <img
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-justify text-sm font-normal text-slate-600 md:text-sm dark:text-neutral-300">
            ...
            <br />
            <br />➜ Developed and automated data analysis workflows using Python and SQL designed
            interactive Tableau dashboards to monitor KPIs including revenue growth, cost
            optimization, client segmentation and team productivity.
            <br />
            <br />➜ Maintained relationships with 10+ local and international clients, primarily in
            the IT and Finance Industry.
          </p>
        </div>
      ),
    },
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-justify text-sm font-normal text-slate-600 md:text-sm dark:text-neutral-300">
            ...
            interaction.
            <br />
            <br />➜ Implemented a testing platform using ReactJS & FastAPI to validate pipeline
            compatibility across diverse use cases; deployed initial prototypes on Microsoft Azure
            using containerized services enabling scalable integration into the core application
            architecture.
          </p>
          <div className="grid grid-cols-1 gap-4">
            <img
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-justify text-sm font-normal text-slate-600 md:text-sm dark:text-neutral-300">
            ...
            customer engagement.
            <br />
            <br />➜ Developed iterations of a centralized social media management platform using
            ReactJS to integrate multiple platforms (Facebook, Instagram, Google My Business),
            consolidating data sources and performance metrics into a single, user-friendly
            interface.
            <br />
            <br />➜ Integrated AI-powered caption generation and implemented Redux with Facebook’s
            Graph API to deliver seamless rendering of posts, likes, comments and engagement
            statistics hence enabling full-cycle content publishing without switching between
            applications. Rendered real-time notifications using WebSockets to alert users of new
            activity, increasing platform engagement and responsiveness.
          </p>
          <div className="grid grid-cols-1 gap-4">
            <img
